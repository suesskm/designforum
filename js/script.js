...
gltfLoader.load('../models/cd_3d_model.glb', function(gltf){
    orb = gltf.scene;
    orb.scale.set(3,3,3);
    orb.position.set(-1.2,3,2);
     scene.add(orb);
...
function onMouseMove(event) {
    ...
    orb.rotation.y += deltaMove.x * rotationSpeed;
    orb.rotation.x += deltaMove.y * rotationSpeed;
